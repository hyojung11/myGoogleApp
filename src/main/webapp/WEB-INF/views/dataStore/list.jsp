...
<body>
	...
	Function : <a href="dataStore/addCustomerPage">Add Customer</a>
	<hr />
	...
	<table border="1">
		...
		%>
			<tr>
				...
				<td><a href="dataStore/update/<%=e.getProperty("name")%>">Update</a> | <a href="dataStore/delete/<%=e.getProperty("name")%>">Delete</a></td>
			</tr>
		<%
			}
		%>
